 ...
 *   - No credentials, or  -> SoftAP "ups-esp32-XXXX" + captive portal, so
 *     BOOT pressed 5 times    setup happens in a browser with no app and no
 *                             serial console.
 *
...
/* This board's own name: ups-esp32-XXXX, the last four hex digits of its
